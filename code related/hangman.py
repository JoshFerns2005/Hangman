            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN or event.key == pygame.K_KP_ENTER:
                    ...
                    if word != ans:
                        ...
                        if i == 1:
                            insert_img("Frames/Head.jpg", (330, 330), 80, 30)
                            G_logic(bttn1, bttn2, running, 2, ques, ans)
                        elif i == 2:
                            insert_img("Frames/Torso.jpg", (330, 330), 80, 30)
                            G_logic(bttn1, bttn2, running, 3, ques, ans)
                        elif i == 3:
                            insert_img("Frames/LHand.jpg", (330, 330), 80, 30)
                            G_logic(bttn1, bttn2, running, 4, ques, ans)
                        elif i == 4:
                            insert_img("Frames/RHand.jpg", (330, 330), 80, 30)
                            G_logic(bttn1, bttn2, running, 5, ques, ans)
                        elif i == 5:
                            insert_img("Frames/LLeg.jpg", (330, 330), 80, 30)
                            G_logic(bttn1, bttn2, running, 6, ques, ans)
                        elif i == 6:
                            insert_img("Frames/RLeg.jpg", (330, 330), 80, 30)
...
def game():
    ...
    screen.fill(black)
    insert_img("Frames/MM_BG_Image.png", (500, 600), 0, 0)
    #Inserting the base image of hangman
    insert_img("Frames/Base.jpg", (340, 330), 80, 30)
...
def main_menu():
    ...
    while True:
        ...
        #Inserting images
        insert_img("Frames/MM_BG_Image.png", (500, 600), 0, 0)
        insert_img("Frames/hangman.png", (200, 200), 40, 40)
